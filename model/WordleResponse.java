...
public class WordleResponse {
	...
	//Assist Testing
	public boolean compareWordleResponse(WordleResponse wr) {
		if(wr.getChar()==c && wr.getBackgroundColor()==this.getBackgroundColor() && wr.getForegroundColor()==this.getForegroundColor()) {
			return true;
		}
		return false;
	}
