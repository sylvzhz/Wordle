...
public class Statistics {
	...
	public Statistics(String difficultyLevel) {
		this.wordsGuessed = new ArrayList<>();
	    String fileSeparator = System.getProperty("file.separator"); 
	    this.path = System.getProperty("user.home") + fileSeparator + "Wordle"; //find path where .log files are stored
	    this.log = fileSeparator + "statistics_" + difficultyLevel.toLowerCase() + ".log"; //CHANGE: get the .log for the specific difficulty
