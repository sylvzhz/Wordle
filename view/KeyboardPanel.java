...
public class KeyboardPanel {
	...
	private JPanel createQPanel() { // create the first row of the keyboard starting with Q
	...
	private JPanel createAPanel() { // create the first row of the keyboard starting with A
		JPanel panel = new JPanel(new FlowLayout());
		panel.setBorder(BorderFactory.createEmptyBorder(0, 5, 0, 5));
		Font textfont = AppFonts.getTextFont();
	...
	private JPanel createZPanel() { // create the first row of the keyboard starting with Z
		JPanel panel = new JPanel(new FlowLayout());
		panel.setBorder(BorderFactory.createEmptyBorder(0, 5, 0, 5));
		Font textfont = AppFonts.getTextFont();
